#ifndef _BREAK_SKETCH_IMPROVED_BIGTS255_H
#define _BREAK_SKETCH_IMPROVED_BIGTS255_H
...
using namespace std;
class Break_Sketch_improved_bigTS255 : public Break_Sketch
{
public:
...
public:
    Break_Sketch_improved_bigTS255(int memory, int hash_seed = 1000)
        : Break_Sketch(memory)
    {
        size = memory / 16;
    ...
    string Name()
    {
        return string("Break_Sketch_improved_bigTS255");
    }
