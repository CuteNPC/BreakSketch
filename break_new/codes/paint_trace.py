...
no = 1
while no <= 128:
    file = open("./break_new/result/traceinfo/trace"+str(no)+".txt")
    ...
    plt.savefig("./break_new/result/traceinfo/trace"+str(no)+".png",
                dpi=1000, bbox_inches='tight')
    plt.close()
    print("./break_new/result/traceinfo/trace"+str(no)+".png")
    no = no*2
