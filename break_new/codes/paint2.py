...
def paint_F1():
    F1csv = pd.read_csv(u'./break_new/codes/res2/F1.csv')
    ...
    plt.legend()
    plt.savefig('./break_new/codes/res2/F1score.png', dpi=300, bbox_inches='tight')
    plt.show()
    plt.cla()


def paint_RR():
    F1csv = pd.read_csv(u'./break_new/codes/res2/Recall.csv')
    ...
    plt.savefig('./break_new/codes/res2/Recall.png', dpi=300, bbox_inches='tight')
    plt.show()
    plt.cla()


def paint_PR():
    F1csv = pd.read_csv(u'./break_new/codes/res2/Precision.csv')
    ...
    plt.savefig('./break_new/codes/res2/Precision.png', dpi=300, bbox_inches='tight')
    plt.show()
    plt.cla()
